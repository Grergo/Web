		...
		<div style="display: flex; flex-wrap: wrap; width: 950px;background: #f1f2f6;margin-bottom: 50px;border-radius: 5px;">
			...
			<div class="products">
				...
				<% 
					...
					ArrayList<Map<String,String>> news=showUtils.Select_fashion_news();
					if(news.size()!=0){
				...
				<div class="product_special">
					<% 
					ArrayList<Map<String,String>>special=showUtils.get_fashion("是");
					if(special.size()!=0){
				...
				<div class="product_all">
					<% 
					ArrayList<Map<String,String>>allprod=showUtils.get_fashion(null);
					if(allprod.size()!=0){
