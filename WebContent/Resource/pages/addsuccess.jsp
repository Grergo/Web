...
<body>
	...
	<div class="basic-grey" style="background: #FFFFFF;">
		<h1>
			<img src="../images/shopping_cart.png" style="width: 100px;">成功加入购物车 <span style="margin-top: 20px;margin-left: 60px;font-size: 16px;">商品已成功加入购物车！<a href="shopping_cart.jsp">点击此跳转到购物车</a></span>
		</h1>
	</div>
