			...
			<div class="products">
				...
				<%
					ShowUtils showUtils=new ShowUtils();
									ArrayList<Map<String,String>> news=showUtils.Select_news("礼物");
									if(news.size()!=0){
				...
				<div class="product_special">
					<% 
					ArrayList<Map<String,String>>special=showUtils.Select_assigned_product("礼物", "是");
					if(special.size()!=0){
				...
				<div class="product_all">
					<% 
					ArrayList<Map<String,String>>allprod=showUtils.Select_assigned_product("礼物", null);
					if(allprod.size()!=0){
